...
@objc public protocol ZMClientRegistrationStatusDelegate: class {
    @objc(didRegisterUserClient:)
    func didRegister(_ userClient: UserClient!)
}

@objc public protocol ZMSyncStateDelegate: ZMClientRegistrationStatusDelegate {
