...
protocol KeyPathObjectSyncTranscoder: class {
    ...
    /// Called when a object needs to be synchchronized. It's the transcoder's responsibllity to update the value of the KeyPath when synchronization is successfull.
    ///
    /// - parameters:
