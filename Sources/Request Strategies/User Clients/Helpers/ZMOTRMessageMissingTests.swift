...
class ZMOTRMessageMissingTests: MessagingTestBase {
    ...
    func testThatItInsertsMissingClientsFromUploadResponse() {
        ...
        self.syncMOC.performGroupedBlockAndWait {
            ...
            // WHEN
            _ = self.message.parseUploadResponse(ZMTransportResponse(payload: payload as NSDictionary, httpStatus: 200, transportSessionError: nil, apiVersion: .v0), clientRegistrationDelegate: MockClientRegistrationStatus())
            self.syncMOC.saveOrRollback()
