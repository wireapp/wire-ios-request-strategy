...
extension ClientMessageTranscoderTests {
    ...
    func testThatItObfuscatesEphemeralMessagesOnStart_SenderSelfUser_TimePassed() {
        ...
        self.syncMOC.performGroupedBlockAndWait {
            ...
            XCTAssertTrue(self.groupConversation.recentMessages.contains(message))
        }
    }
    ...
    func testThatItDeletesEphemeralMessagesOnStart_SenderOtherUser_TimePassed() {
        ...
        self.syncMOC.performGroupedBlockAndWait {
            ...
            let generic = ZMGenericMessage.message(text: text, nonce: UUID.create(), expiresAfter: 5)
        ...
        let message = uiConversation.recentMessages.last!
