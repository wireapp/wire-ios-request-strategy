...
public final class ClientMessageRequestFactory: NSObject {
    ...
    public func requestToGetAsset(_ assetId: UUID, inConversation conversationId: UUID, isEncrypted: Bool) -> ZMTransportRequest {
        let path = "/" + ["conversations", conversationId.transportString(), isEncrypted ? "otr" : "", "assets", assetId.transportString()].joined(separator: "/")
