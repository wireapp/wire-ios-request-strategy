...
class OTREntityTranscoderTests: MessagingTestBase {
    ...
    func testThatItHandlesDeletionOfSelfClient() {
        self.syncMOC.performGroupedAndWait { _ in
            ...
            let response = ZMTransportResponse(payload: payload as NSDictionary, httpStatus: 403, transportSessionError: nil, apiVersion: 0)
    ...
    func testThatItHandlesDeletionOfClient() {
        self.syncMOC.performGroupedAndWait { _ in
            ...
            let response = ZMTransportResponse(payload: payload as NSDictionary, httpStatus: 200, transportSessionError: nil, apiVersion: 0)
