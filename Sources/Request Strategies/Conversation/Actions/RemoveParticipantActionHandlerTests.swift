...
class RemoveParticipantActionHandlerTests: MessagingTestBase {
    ...
    func testThatItParsesAllKnownRemoveParticipantErrorResponses() {
        ...
        let errorResponses: [(ConversationRemoveParticipantError, ZMTransportResponse)] = [
            (ConversationRemoveParticipantError.invalidOperation, ZMTransportResponse(payload: ["label": "invalid-op"] as ZMTransportData, httpStatus: 403, transportSessionError: nil, apiVersion: 0)),
            (ConversationRemoveParticipantError.conversationNotFound, ZMTransportResponse(payload: ["label": "no-conversation"] as ZMTransportData, httpStatus: 404, transportSessionError: nil, apiVersion: 0))
        ]
