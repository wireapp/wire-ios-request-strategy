...
class LinkPreviewRequestStrategyTests: MessagingTestBase {

    private var sut: LinkPreviewRequestStrategy!
    ...
    override func setUp() {
        ...
        self.syncMOC.performGroupedAndWait { syncMOC in
            ...
            self.sut = LinkPreviewRequestStrategy(withManagedObjectContext: syncMOC, applicationStatus: self.applicationStatus)
        }
    }
