...
class AssetsPreprocessorTests: MessagingTestBase {
    ...
    func testThatItPreprocessAssetMessageWithMultipleAssets() {
        // given
        let message = conversation.appendFile(with: ZMVideoMetadata(fileURL: self.fileURL(forResource: "video", extension: "mp4"), thumbnail: self.verySmallJPEGData())) as! ZMAssetClientMessage
